...
import { patientNoteSchema } from "../schemas";
export function PatientNotes({ notes, onAddNote }) {
    ...
    return (<div className="space-y-4">
      <form onSubmit={handleSubmit(onSubmit)} className="flex gap-2">
        <div className="flex-1">
          <input type="text" placeholder="Add an internal note..." {...register("content")} disabled={saving} className="w-full rounded-lg border bg-background px-3 py-2 text-sm disabled:opacity-60"/>
