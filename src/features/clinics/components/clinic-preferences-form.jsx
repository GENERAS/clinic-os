...
export function ClinicPreferencesForm({ preferences, isOwner, onSave }) {
    ...
    return (<SectionCard title="Clinic Preferences" description="System-wide configuration defaults" actions={!isOwner && (<span className="flex items-center gap-1 text-xs text-muted-foreground">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="grid gap-6 sm:grid-cols-2">
          <div>
            ...
            <select id="currency" {...register("currency")} disabled={!isOwner} className="w-full rounded-lg border bg-background px-3 py-2 text-sm disabled:opacity-60">
          ...
          <div>
            ...
            <select id="language" {...register("language")} disabled={!isOwner} className="w-full rounded-lg border bg-background px-3 py-2 text-sm disabled:opacity-60">
          ...
          <div>
            ...
            <select id="date_format" {...register("date_format")} disabled={!isOwner} className="w-full rounded-lg border bg-background px-3 py-2 text-sm disabled:opacity-60">
          ...
          <div>
            ...
            <select id="time_format" {...register("time_format")} disabled={!isOwner} className="w-full rounded-lg border bg-background px-3 py-2 text-sm disabled:opacity-60">
