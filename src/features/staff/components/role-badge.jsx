...
export function RoleBadge({ role, className }) {
    return (<span className={cn("inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium", roleStyles[role] || "bg-gray-100 text-gray-700 dark:bg-gray-900/30 dark:text-gray-400", className)}>
      {role}
    </span>);
}
