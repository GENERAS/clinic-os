...
import type { InventoryItemWithDetails, InventoryTransactionWithUser } from "@/features/inventory/types"
import type { StockAdjustmentFormValues } from "@/features/inventory/schemas"
...
export default function InventoryItemDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [transactions, setTransactions] = useState<InventoryTransactionWithUser[]>([])
  ...
  const handleAdjust = async (values: StockAdjustmentFormValues) => {
