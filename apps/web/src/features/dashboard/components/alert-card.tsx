    ...
    <div className="space-y-2">
      {alerts.slice(0, 5).map((alert) => (
        <Link
          ...
          className="flex items-center gap-3 rounded-lg border border-amber-200 bg-amber-50/50 p-3 transition-colors hover:bg-amber-50 dark:border-amber-900/30 dark:bg-amber-950/20 dark:hover:bg-amber-950/30"
        >
