...
interface ClinicBrandingFormProps {
  logoUrl: string | null
  isOwner: boolean
...
export function ClinicBrandingForm({ logoUrl, isOwner, onUpload, onDelete, isUploading }: ClinicBrandingFormProps) {
  return (
    <SectionCard
      title="Clinic Branding"
      description="Upload your clinic logo for display across the system"
      actions={
        !isOwner && (
