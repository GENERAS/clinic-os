...
import { inviteStaffSchema, type InviteStaffFormValues } from "../schemas/staff.schema"

interface InviteStaffDialogProps {
  open: boolean
  onClose: () => void
  onInvite: (values: InviteStaffFormValues) => Promise<void>
  roles: { id: string; name: string }[]
}

export function InviteStaffDialog({ open, onClose, onInvite, roles }: InviteStaffDialogProps) {
